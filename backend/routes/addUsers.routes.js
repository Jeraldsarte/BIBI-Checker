...
const config = require('../backend/database/config.json');
...
profile.post("/add", (req, res) => {
  db.sequelize
    .query(
      "CALL sp_profile_add( :name, :barangay_id, :age, :gender, :civil_status, :educational_attainment, :no_of_household_members, :annual_farm_income, :name_of_business, :business_address, :year_business_start, :contact_no, :business_status, :business_type, :initial_investment, :ave_annual_gross_income, :purok, @profile_id)",
      {
        replacements: {
          name: req.body.name,
